...
class BART:
    ...
    def decode(self, ld_lines, max_num = None):
        ...
        for idx, line in enumerate(src_lines):
            ...
            summary_ids = self.model.generate(torch.LongTensor(src_tokens).unsqueeze(0).cuda(), do_sample = False, num_beams=5, min_length=0, max_length = 100) # if i don't set this, it will be default to 20 
